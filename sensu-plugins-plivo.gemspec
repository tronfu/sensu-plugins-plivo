...
if RUBY_VERSION < '2.3.0'
  require 'sensu-plugins-plivo'
else
  require_relative 'lib/sensu-plugins-plivo'
end
...
Gem::Specification.new do |s|
  ...
  s.description            = 'Sensu plugins for plivo'
  s.email                  = '<sensu-users@googlegroups.com>'
  s.executables            = Dir.glob('bin/**/*.rb').map { |file| File.basename(file) }
  s.files                  = Dir.glob('{bin,lib}/**/*') + %w(LICENSE README.md CHANGELOG.md)
  s.homepage               = 'https://github.com/sensu-plugins/sensu-plugins-plivo'
  s.license                = 'MIT'
  ...
  s.name                   = 'sensu-plugins-plivo'
  s.platform               = Gem::Platform::RUBY
  s.post_install_message   = 'You can use the embedded Ruby by setting EMBEDDED_RUBY=true in /etc/default/sensu'
  s.require_paths          = ['lib']
  s.required_ruby_version  = '>= 2.3.0'

  s.summary                = 'Sensu plugins for plivo'
